...
export default function SystemHistoryPage() {
    return (
        <ProtectedRoute>
            <SystemHistoryContent />
        </ProtectedRoute>
    );
}

function SystemHistoryContent() {
    ...
    // Mock Data
    const historyData = [
        { id: 1, action: 'ใส่ OTP', date: '17/12/2568 09:10:40' },
        { id: 2, action: 'เข้าสู่ระบบ', date: '17/12/2568 09:10:35' },
        { id: 3, action: 'ใส่ OTP', date: '17/12/2568 09:10:30' },
        { id: 4, action: 'เข้าสู่ระบบ', date: '17/12/2568 09:10:20' },
        { id: 5, action: 'ใส่ OTP', date: '17/12/2568 09:10:10' },
    ];
            ...
            <main className="relative z-10 flex-1 flex flex-col items-center justify-start p-4 w-full max-w-md mx-auto">
                ...
                <div className="w-full bg-white rounded-2xl shadow-xl p-4 flex flex-col mt-2 min-h-[600px] relative">
                    ...
                    <div className="flex items-center mb-4">
                        ...
                        <h1 className="text-xl font-bold text-gray-900">ประวัติการใช้งานระบบ</h1>
                    </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    ...
                                    onChange={(e) => setFilters(prev => ({ ...prev, login: e.target.checked }))}
                                    className="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                />
                                <span className="text-gray-700">เข้าสู่ระบบ</span>
                            </label>
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    type="checkbox"
                                    checked={filters.logout}
                                    onChange={(e) => setFilters(prev => ({ ...prev, logout: e.target.checked }))}
                                    className="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                />
